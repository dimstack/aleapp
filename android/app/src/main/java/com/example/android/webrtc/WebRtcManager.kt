...
class WebRtcManager(
    ...
    private val peerConnectionFactory: PeerConnectionFactory by lazy { createFactory() }
    ...
    fun createPeerConnection(serverAddress: String) {
        this.serverAddress = serverAddress
        val iceServers = buildIceServers(serverAddress)
    ...
    private fun buildIceServers(serverAddress: String): List<PeerConnection.IceServer> {
    ...
    companion object {
        ...
        private const val TURN_USERNAME = "callapp"
        private const val TURN_PASSWORD = "callapp"
