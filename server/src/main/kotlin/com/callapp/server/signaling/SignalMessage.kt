...
sealed class SignalMessage {
    ...
    fun toJson(): String = signalJson.encodeToString(serializer(), this)

    companion object {
        fun fromJson(text: String): SignalMessage = signalJson.decodeFromString(serializer(), text)
    }
}
